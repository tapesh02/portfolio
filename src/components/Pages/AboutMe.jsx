            ...
            <Box className="main-resume">
                ...
                <Box className="main-resume-overview">
                    <p className="resume-overviewText">
                        Motivated web developer with a proven track record and progressive experience in the IT industry. Offering expertise in web development, and eye-catching user-interface, with
                        aptitude in power platform (office 365 suits). An energetic self-starter and team builder able to navigate high-stress situations and achieve goals on time and under budget.
                    </p>
                </Box>
                    ...
                    <Box className="contact-bg">
                        <Box className="contact-form">
                            <form onSubmit={handleSubmit} autoComplete="off">
                                ...
                                <p style={showMessage === true ? { display: "inherit" } : { display: "none" }}> Your message was sent successfuly. Thanks you ! </p>
                            </form>
                        </Box>

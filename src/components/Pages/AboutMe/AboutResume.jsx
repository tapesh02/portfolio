...
const AboutResume = () => {
  const RenderResumeDetails = () =>
    resumeDetails.map((details, i) => (
      <div key={i} className="resume-content" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1500">
  ...
  return (
    <Box className="main-resume">
      <AboutHeader
        ...
        overviewText={
          "Motivated web developer with a proven track record and progressive experience in the IT industry, offering expertise in web development, and eye-catching user interface. An energetic self-starter and team builder able to navigate high-stress situations and achieve goals on time and under budget."
        }
      />

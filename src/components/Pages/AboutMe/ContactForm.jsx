        ...
        <Box className="contact-bg">
            ...
            <form onSubmit={handleSubmit} autoComplete="off">
              {["name", "email", "phone", "message"].map((field) => (
                <TextField
                  ...
                  autoComplete="off"
                  error={errors[field]}
                  helperText={errors[field] ? `${field} required minimum ${field === "phone" ? 7 : 6} characters` : ""}
          ...
          <Box className="connected-bg">
            <Box className="connected-details">
              <p className="connected-title">
                Let's <br />
                Get <br />
                Connected
              </p>
              <p className="connected-subtitle">
                Got something for me? <span>Don't hesitate to send message</span>
              </p>
            </Box>
